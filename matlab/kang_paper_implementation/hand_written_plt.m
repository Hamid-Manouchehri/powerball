...
for exp_idx = 1:5  % # experiments
    ...
    for s_idx = 1:4  % subject index

        save_hand_written_maze_file = sName(s_idx) + "_exp" + num2str(exp_idx) + "_hw_mat.mat";
        read_hand_written_maze_mat = hand_written_maze_dir + "data_" + sName(s_idx) + "/maze_INK_" + sName(s_idx) + "_exp_" + num2str(exp_idx) + ".mat";
        load_hand_written_maze = load(read_hand_written_maze_mat);
