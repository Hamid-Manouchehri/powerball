...
read_schunk_file = ["hamid_exp1_damp_10_mat.mat", ...
                    "hamid_exp1_damp_50_mat.mat", ...
                    "hamid_exp1_damp_100_mat.mat"];  % TODO

read_hand_written_file = "hamid_exp1_hw_mat.mat";  % TODO

dir = "/home/hamid-tuf/projects/powerball/matlab/23_power_law/data/admittance/IDETC26/mat/";
...
for i = 1:length(read_schunk_file)
    load_schunk_admittance = load(read_schunk_file(i));   % load directly, no double-load
    t_schunk                = load_schunk_admittance.schunk_time_s;
    x_schunk                = load_schunk_admittance.x;
    y_schunk                = load_schunk_admittance.y;
    R_schunk                = load_schunk_admittance.R;
    ...
    bar(entropy_schunk);
    ylim([0 3.5])
    % title("entropy: " + read_schunk_file(i));
    set(gca, 'XTick', 1:numel(load_schunk_admittance.entropy.zone_name), ...
             'XTickLabel', load_schunk_admittance.entropy.zone_name);
end