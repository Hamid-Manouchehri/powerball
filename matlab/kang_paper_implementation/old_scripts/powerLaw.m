...
for s_idx = 1:4
    for exp_idx = 1:5
        for d_idx = 1:3
            ...
            save_schunk_mat_file = mat_dir + sName(s_idx) + "_exp" + num2str(exp_idx) + ...
                "_damp_" + num2str(dValue(d_idx)) + "_mat.mat";

            read_schunk_csv = csv_dir + "data_" + sName(s_idx) + "/" + sName(s_idx) + ...
                "_exp" + num2str(exp_idx) + "_schunk_damp_" + num2str(dValue(d_idx)) + ".000000.csv";
            ...
            save(save_schunk_mat_file, 'schunk_time_s', 'x', 'y', ...
                'window_center_time', ...
