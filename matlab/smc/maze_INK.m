...
saveName = input('Enter .mat file name: ', 's');
...
if nargin < 1
    % bgFile = './img/original/star_small.png';  % background image
    % bgFile = './img/original/eight_no_boundary.png';  % background image
    bgFile = './img/original/eight_small.png';  % background image
    % bgFile = './img/original/clover_small.png';  % background image
end
...
% =========================================================
    ...
    function save_callback(~,~)
        ...
        pts = points(1:pID,:);
        save(fullfile('./data/hand_drawing', saveName), 'pts');
        fprintf('Saved to %s\n', saveName);
    end
