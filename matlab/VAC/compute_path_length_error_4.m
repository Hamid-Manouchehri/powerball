...
shape_id = 2;         % TODO [eight_sign:1, ellipse:2, four_leaves:3, squircle:4]
controller_id = 4;    % TODO [chen:1, kang_indirect:2, chen_ls:3, chen_kf:4]
reference_path_length = 3 * 0.9688;  % TODO [eight_sign:1.076, ellipse:0.9688,
%  four_leaves:1.211, squircle:1.1228] m for 3 repetitions.

write_master_csv_file = "./processed_data/master_dataset_chen_ls_kf_study_2.csv";  % TODO
